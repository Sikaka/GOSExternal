...
local ORBWALKER_MODE_ORBWALKER			= _G.SDK.ORBWALKER_MODE_ORBWALKER;
...
class "__Orbwalker"
	function __Orbwalker:__init()
		...
		self.Modes = {
			...
			[ORBWALKER_MODE_ORBWALKER] = false,
	...
	function __Orbwalker:OnLoad()
		...
		self.Menu:MenuElement({ id = "Keys", name = "Keys Settings", type = MENU });
			...
			self.Menu.Keys:MenuElement({ id = "Orbwalker", name = "Orbwalker", key = string.byte(" ") });
			self:RegisterMenuKey(ORBWALKER_MODE_ORBWALKER, self.Menu.Keys.Orbwalker);
	...
	function __Orbwalker:GetTarget()
		...
		local hero = nil;
		if self.Modes[ORBWALKER_MODE_COMBO] or self.Modes[ORBWALKER_MODE_ORBWALKER] or self.Modes[ORBWALKER_MODE_HARASS] or (self.Modes[ORBWALKER_MODE_LANECLEAR] and LaneClearHeroes) then
		...
		if self.Modes[ORBWALKER_MODE_ORBWALKER] then
	...
	function __Orbwalker:GetModes()
		return {
			...
			[ORBWALKER_MODE_ORBWALKER] 		= self:HasMode(ORBWALKER_MODE_ORBWALKER),
...
class "__EOW"
	...
	function __EOW:Mode()
		if Orbwalker.Modes[ORBWALKER_MODE_COMBO] then
			return "Combo";
		elseif Orbwalker.Modes[ORBWALKER_MODE_ORBWALKER] then
			return "Orbwalker";
